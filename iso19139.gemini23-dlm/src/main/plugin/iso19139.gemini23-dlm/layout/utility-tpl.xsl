...
<xsl:import href="../../iso19139/layout/utility-tpl.xsl"/>
 ...
 <xsl:template name="get-iso19139.gemini23-dlm-title">
    <xsl:call-template name="get-iso19139-title"/>
  </xsl:template>

	<xsl:template name="get-iso19139.gemini23-dlm-is-service">
		<xsl:call-template name="get-iso19139-is-service"/>
	</xsl:template>

	<xsl:template name="get-iso19139.gemini23-dlm-extents-as-json">
		<xsl:call-template name="get-iso19139-extents-as-json"/>
	</xsl:template>

  <xsl:template name="get-iso19139.gemini23-dlm-online-source-config">
